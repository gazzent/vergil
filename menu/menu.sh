...
echo -e " ${YEL}│${RE}[${BIWhite}44${RE}] UPGRADE SCRIPT ${BICyan}"
echo -e " ${YEL}└─────────────────────────────────────────────────────┘${NC}"
echo -e "${YEL} ┌─────────────────────────────────────────────────────┐${NC}"
...
9) clear ; certv2ray ;;
10) clear ; running ;;
11) clear ; wget https://raw.githubusercontent.com/nevermoressh/vergil/main/backup/set-br.sh && bash set-br.sh ;;
