...
echo -e " ${YEL}┌─────────────────────────────────────────────────────┐${NC}"
echo -e " ${YEL}│${RE}[${BIWhite}01${RE}] SSH      ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"    " ${RE}[${BIWhite}06${RE}] SETTING   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${BICyan}   │"
echo -e " ${YEL}│${RE}[${BIWhite}02${RE}] VMESS    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" " ${RE}[${BIWhite}07${RE}] BACKUP    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${BICyan}   │"
echo -e " ${YEL}│${RE}[${BIWhite}03${RE}] VLESS    ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  " ${RE}[${BIWhite}08${RE}] ADD-HOST      ${NC}" "${BICyan}     │"
echo -e " ${YEL}│${RE}[${BIWhite}04${RE}] TROJAN   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" " ${RE}[${BIWhite}09${RE}] GEN SSL             ${NC}" "${BICyan}│"
